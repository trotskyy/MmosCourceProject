...
namespace DomainModelValidation.Abstract
{
    ...
    /// </summary>
    public interface IExceptionRuleSet<TUnitOfWork>
        where TUnitOfWork : class
    {
        ...
        /// <returns></returns>
        IExceptionRule<TDbEntity, TUnitOfWork> AddRule<TDbEntity>(Func<TDbEntity, TUnitOfWork, bool> validationRulePredicate)
