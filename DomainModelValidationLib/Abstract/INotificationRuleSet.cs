...
namespace DomainModelValidation.Abstract
{
    ...
    /// </summary>
    public interface INotificationRuleSet<TUnitOfWork>
        where TUnitOfWork : class
    {
        ...
        /// <returns></returns>
        INotificationRule<TDbEntity, TUnitOfWork> AddRule<TDbEntity>(Func<TDbEntity, TUnitOfWork, bool> validationRulePredicate)
